...
2. **랜딩 — course-11에 Part 6(15차) 추가** (`courseDetails["course-11"].parts`): 판별 3조건 / 5요소→I-MRKO 변환표 + 예시의 함정 / 엔진·비교 3질문. FAQ 2건 정정(13차·15차 채점 미사용 / 15차 소재는 반복 업무). page.tsx 수정 없음·ctas 없음
