...
export const courses = [
  ...
  },
  {
    ...
    subtitle: "중급반 1강. 매주 점수를 받던 채점기의 속을 펼친다 — 폴더는 왜 갈라졌고, 파일은 왜 그 자리에 있나",
    duration: "약 160분 (강의 130여 분 + 숙제 브리핑 + 휴식 10)",
    level: "중급반 (10차 진단 기반 배정)",
    framework: "개발 지도 3층",
    frameworkFull: "지형·골목·문패",
    heroQuote: "모든 파일에는 자리가 있고, 그 자리에는 이유가 있다",
    tagline: "중급반 현재 계획 3회: 구조를 그린다(12차) → 화면을 그린다(14차) → 데이터를 그린다(16차) — 숙제 3연쇄 「내 앱 설계 3종 세트」",
    prerequisite: "10차 진단 (중급반 배정) · 1~10차 전체 수강 가정 · 채점 플랫폼 미사용 — 강의 + 숙제(구조도) · 코드는 띄우지 않는다",

    promises: [
      "프론트엔드·백엔드·DB·API가 정확히 무엇이고 왜 존재하는지 바닥부터 이해한다 — 이미 다 해봤던 것들에 이름을 붙인다",
      "채점기 레포의 폴더 하나하나가 왜 있는지 읽을 수 있게 된다 — 내가 만든 건 절반뿐, 나머지는 도구가 만든 것",
      "좋은 구조의 원칙 5로 내 앱 구조도를 스스로 검사하고, 설계지 4쪽에 그려 나간다 — 「내 앱 설계 3종 세트」의 첫 장"
    ],

    beforeAfter: {
      title: "같은 채점 버튼을 본 두 개의 눈",
      before: {
        label: "Before (버튼을 누르는 사람)",
        prompt: "채점하기를 누르면 점수가 나온다",
        result: "그 3초 동안 무슨 일이 어디서 일어나는지 아무도 설명할 수 없다"
      },
      after: {
        label: "After (지도를 든 사람)",
        prompt: "버튼[화면] → /api/score[연결] → 채점 기준+Claude[동작, 열쇠는 서버에서만] → 결과 카드[화면] → Supabase[데이터] → 리더보드",
        result: "폴더마다 이유를 적을 수 있다 — 그게 곧 설계"
      }
    },

    curriculum: [
      { section: "Part 0 — 중급반 개강: 진단받던 도구가 교재가 된다 · 핵심 메시지", time: "12분", slides: "1~4" },
      { section: "Part 1 — 지형: 주소창의 여정 · 브라우저와 서버 · 프론트 · 백(비밀·신뢰·힘) · DB(동시성·검색·규칙) · API", time: "55분", slides: "5~12", highlight: true },
      { section: "Part 2·3 — 골목: 루트 트리 · 안 만든 파일들(재료 목록·창고·열쇠·문지기) · 이름 정리(러시아 인형) · src 다섯 골목 · 폴더가 곧 주소", time: "45분", slides: "13~19" },
      { section: "Part 4·5 — 좋은 구조의 원칙 5 · 채점 버튼의 여정 · 숙제: 내 앱 구조도", time: "38분", slides: "20~23", highlight: true }
    ],

    killerInsights: [
      {
        title: "node_modules를 지워도 되는 이유",
        description: "가장 무거운 폴더를 지워도 앱은 살아난다 — 재료 목록(package.json)만 있으면 창고는 다시 산다. 내가 만든 것과 도구가 만든 것을 가르는 첫 감각",
        quote: "목록만 있으면 창고는 재생된다"
      },
      {
        title: "열쇠는 서버에서만",
        description: "백엔드를 숨기는 이유는 셋 — 비밀(API 키), 신뢰(채점 기준을 손댈 수 없게), 힘(무거운 일은 서버가). 이 기능은 브라우저에서 도나, 서버에서 도나 — 셋 중 하나에 걸리면 서버다",
        quote: "비밀·신뢰·힘 중 하나에 걸리면 서버다"
      }
    ]
  },
  {
    ...
    subtitle: "초급반 2강. 백지에서 시작하지 않는다 — 11차에 그린 네 칸을 변환표 4줄로 문장으로 옮기고, claude.ai에 띄운다",
    duration: "120분 (강의 47 + 실습 73)",
    level: "초급반 2강 (11차 이어서)",
    framework: "변환표 4줄",
    frameworkFull: "데이터→맥락+제약 · 동작→목적+제약 · 화면→출력+디바이스 · 연결→제약",
    heroQuote: "프롬프트는 창작이 아니라 번역이다 — 실력은 두 번째 실행에서 는다",
    tagline: "초급반 현재 계획 3회: 그린다(11차) → 쓴다(13차) → 굳힌다(15차)",
    prerequisite: "11차 구조도 (없어도 첫 8분에 다시 그린다) · claude.ai 로그인 + 노트북 또는 폰 · 채점 플랫폼 미사용 — 피드백은 뜬 화면 그 자체",

    promises: [
      "구조도 네 칸을 변환표 4줄에 따라 칸당 1~2문장으로 옮기고, 역할→목적→맥락→제약→출력 순으로 이어 붙여 250~500자 완성형 프롬프트를 만든다",
      "완성형을 claude.ai에 직접 실행해 내 앱이 화면에 뜨는 순간을 본다 — 그리고 화면과 구조도의 차이에서 다음에 고칠 문장을 찾는다",
      "「쏘고 → 보고 → 고친다」 루프를 돌려 v2까지 간다 — 대화로 고치지 않고 프롬프트를 고쳐 새 대화에서 다시 실행하는 습관"
    ],

    beforeAfter: {
      title: "같은 메모앱 구조도, 두 개의 프롬프트",
      before: {
        label: "Before (백지에서 짓기)",
        prompt: "메모앱 만들어줘. 예쁘게.",
        result: "PC 기준으로 나와 폰에서 깨지고, 저장은 안 되고, 설명문이 온다"
      },
      after: {
        label: "After (네 칸을 번역하기)",
        prompt: "너는 10년차 모바일 UI 디자이너야. … 폰 세로 화면 기준. 저장 버튼 없이 자동 저장, 껐다 켜도 남아야 해. 로그인 없이, 나 혼자. 한 페이지 HTML 한 파일로 만들어줘.",
        result: "첫 실행부터 작동하는 앱 — 화면 칸이 디바이스 한 줄로 꽂힌 덕"
      }
    },

    curriculum: [
      { section: "Part 0 — 오프닝: 지난 시간 · 구조도 다시 그리기(8분) · 핵심 메시지", time: "18분", slides: "1~4" },
      { section: "Part 1 — 변환표 4줄", time: "6분", slides: "5", highlight: true },
      { section: "Part 2 — 5요소 복습: 역할·목적 / 맥락(Where) / 제약·출력", time: "15분", slides: "6~8" },
      { section: "실습 1 — 다같이 번역 (메모앱, 문답식)", time: "8분", slides: "9", highlight: true },
      { section: "브리핑 — 완성형 · 엔진(라이브 데모) · 규칙 둘", time: "5분", slides: "10~12" },
      { section: "실습 2 — 초벌 번역 15분 + 첫 실행(v1) 8분", time: "23분", slides: "13" },
      { section: "실습 3 — 고치기 루프 27분 + 쇼케이스 10분", time: "37분", slides: "14", highlight: true },
      { section: "클로징 — 15차 예고 · 숙제", time: "8분", slides: "15~16" }
    ],

    killerInsights: [
      {
        title: "디바이스 한 줄이 운명을 가른다",
        description: "맥락의 Where — '폰 세로 화면' 한 줄이 없으면 PC 기준으로 만들어져 폰에서 깨진다. 11차에 화면 칸을 성실히 채운 사람의 앱은 첫 실행부터 깨지지 않는다",
        quote: "11차의 성실함이 13차 결과물로 증명된다"
      },
      {
        title: "연결 칸의 번역은 대부분 빼기다",
        description: "초급 소재에서 연결 칸의 정답은 '로그인 없이', '인터넷 없이', '나 혼자'처럼 금지 문장이 된다 — 연결 칸이 빈 사람도 '혼자 쓴다' 한 줄로 번역할 수 있다",
        quote: "비어 있음도 번역이 된다"
      }
    ]
  },
  {
    ...
    subtitle: "중급반 2강. 매주 눌렀던 채점 화면 한 장을 뼈대·옷·움직임·부품으로 네 번 뜯는다 — 화면 하나는 그림 여러 장이다",
    duration: "약 160분 (강의 130여 분 + 숙제 브리핑 + 휴식 10)",
    level: "중급반 2강 (12차 이어서)",
    framework: "화면 해부 4단",
    frameworkFull: "뼈대(HTML)·옷(CSS)·움직임(JS)·부품(컴포넌트)",
    heroQuote: "화면은 한 장의 그림이 아니라, 부품과 상태의 조립이다",
    tagline: "중급반 현재 계획 3회: 구조를 그린다(12차) → 화면을 그린다(14차) → 데이터를 그린다(16차)",
    prerequisite: "12차 개발 지도 3층 · 채점 플랫폼 미사용 — 강의 + 숙제(화면도) · 코드는 한 장(정체 공개)만 예외",

    promises: [
      "화면을 뼈대(HTML)·옷(CSS)·움직임(JS)·부품(컴포넌트)으로 나눠 보는 눈을 얻는다 — 같은 뼈대에 다른 옷, 누르면 일어나는 일",
      "'화면 하나는 그림 여러 장'(비어 있음·기다림·성공·실패)이라는 상태 감각을 갖고, 빠뜨리는 세 장을 먼저 적게 된다",
      "내 앱의 화면도(화면 목록·이동·상자·부품·상태 4칸)를 종이에 그려 나간다 — 16차 데이터도의 첫 재료"
    ],

    beforeAfter: {
      title: "같은 채점 버튼을 본 두 개의 눈 — 화면판",
      before: {
        label: "Before (성공 화면 한 장만 상상)",
        prompt: "채점 결과가 카드로 예쁘게 나온다",
        result: "기다림 화면이 없어 버튼을 두 번 누르고 두 번 채점된다"
      },
      after: {
        label: "After (4단 + 상태 4장)",
        prompt: "버튼[움직임] → '채점 중…' 잠김 + 회색 상자 셋[기다림 상태] → 결과 카드[부품] → 등록 카드[하단 고정] → 리더보드[이동] / 실패하면 빨간 알림 + 다음 행동",
        result: "화면마다 상태를 적을 수 있다 — 그게 곧 화면 설계"
      }
    },

    curriculum: [
      { section: "Part 0 — 12차 한 장 복습 · 핵심 메시지", time: "15분", slides: "1~3" },
      { section: "Part 1 — 삼형제: 설계도 세 장 · 뼈대(상자 속 상자) · 정체 공개(코드 한 장) · 옷(같은 뼈대 다른 옷) · 움직임(누르면 일어난다) · UI vs UX", time: "52분", slides: "4~11", highlight: true },
      { section: "Part 2 — 부품: 반복에 이름 붙이기 · 빈칸 · 부품 31개 지도 · 사온 부품", time: "33분", slides: "12~15" },
      { section: "Part 3·4 — 상태(화면 하나는 그림 여러 장) · 이동 · 여정 ② 화면판 · 좋은 화면의 원칙 5", time: "40분", slides: "16~19", highlight: true },
      { section: "Part 5 — 숙제: 내 앱 화면도 · 16차 예고(창고 속은 16차에)", time: "10분", slides: "20~22" }
    ],

    killerInsights: [
      {
        title: "화면 하나는 그림 여러 장이다",
        description: "AI에게 화면을 시킬 때 사람은 성공한 화면 한 장만 상상한다. 비어 있을 때·기다릴 때·실패했을 때를 빠뜨리면, 기다림 화면이 없는 앱은 버튼을 두 번 누르게 만들고 두 번 채점된다",
        quote: "빠뜨리는 세 장 — 비어 있음 · 기다림 · 실패"
      },
      {
        title: "반복되면 부품",
        description: "두 번 이상 나오는 상자 묶음에 이름을 붙인 것이 부품 — 다섯 번 그리지 않고 한 번 만든다. 부품엔 빈칸(글자·색·크기)이 있어 하나로 여럿을 만들고, 빈칸으로 안 되는 차이가 있으면 부품을 가른다",
        quote: "채점기가 5종인 이유"
      }
    ]
  },
  {
    id: "course-15",
    title: "굳힌다 — 반복을 지침으로",
    subtitle: "초급반 3강. 매주 다시 하는 일을 AI에게 한 번만 설명해두는 법 — 재료만 바뀌는 일은 지침이 된다",
    duration: "120분 (강의 77 + 실습 43)",
    level: "초급반 3강 (13차 이어서)",
    framework: "I-MRKO 5칸",
    frameworkFull: "정체성·임무·규칙·지식·출력 + 판별 3조건",
    heroQuote: "재료만 바뀌는 일은 지침이 된다 — 지침은 세 번째 재료에서 증명된다",
    tagline: "초급반 현재 계획 3회: 그린다(11차) → 쓴다(13차) → 굳힌다(15차) — 앱은 프롬프트로, 매주 하는 일은 지침으로",
    prerequisite: "가져올 것 없음 — 매주 다시 하는 일 하나만 떠올려 오기 · claude.ai 로그인 + 노트북 또는 폰 · 채점 플랫폼 미사용 — 피드백은 재료 3개의 산출물",

    promises: [
      "지침이 되는 일과 프롬프트로 충분한 일을 판별 3조건(주기·형식·재료)으로 가른다 — 앱은 0개, 주간 보고는 3개",
      "프롬프트 5요소를 지침 I·M·R·K·O로 옮겨 각자의 「○○ 작업실」 지침 한 페이지를 쓴다 — 규칙은 형용사 대신 숫자·금지어·고정 포맷으로",
      "지침을 claude.ai에 등록하고 서로 다른 재료 3개를 넣어 세 산출물이 같은 틀로 나오는지 본다 — 흔들린 줄 하나를 고쳐 두 번째 시험까지"
    ],

    beforeAfter: {
      title: "같은 한 줄, 두 곳에 — 「강의 기획 작업실」",
      before: {
        label: "Before (지침 없는 새 대화)",
        prompt: "다음 주 초급반: 지침",
        result: "되묻거나, 산문으로 길게, 시간 배분 없음 — 매번 이 상태에서 다시 설명해야 한다"
      },
      after: {
        label: "After (지침이 등록된 프로젝트)",
        prompt: "다음 주 초급반: 지침 — 똑같이 한 줄",
        result: "개요표 → 타임라인 → 리스크표 → 산출물, 늘 쓰던 순서로. 재료를 바꿔도 틀이 같다"
      }
    },

    curriculum: [
      { section: "Part 0 — 오프닝: 지난 시간 한 장 · 강사 데모(지침 없이 vs 있이) · 핵심 메시지", time: "16분", slides: "1~4" },
      { section: "Part 1 — 프롬프트 vs 지침(주문 vs 매뉴얼) · 판별 3조건 · 내 반복 업무 찾기(5분)", time: "17분", slides: "5~7", highlight: true },
      { section: "Part 2 — 변환표 5요소→I-MRKO · 정체성 · 임무 · 규칙(승부처) · 지식 · 출력 · 예시의 함정", time: "44분", slides: "8~14", highlight: true },
      { section: "실습 1 — 다같이 지침 쓰기 (주간 보고 작업실, 문답식)", time: "8분", slides: "15" },
      { section: "브리핑 — 완성형 생김새 · 엔진(박고→재료 셋→고친다) · 규칙 둘 · 등록 3갈래", time: "3분", slides: "16~17" },
      { section: "실습 2 — 초벌 지침 12분 + 등록·첫 시험(v1) 8분", time: "20분", slides: "18" },
      { section: "실습 3 — 한 번 고치기 6분 + 쇼케이스 4분", time: "10분", slides: "19" },
      { section: "클로징 — 엔딩 · 다음 안내", time: "2분", slides: "20" }
    ],

    killerInsights: [
      {
        title: "해석의 여지가 있는 규칙은 작동하지 않는다",
        description: "매뉴얼에 '친절하게'라고 쓰면 알바마다 다르게 일한다. '간결하게'는 AI의 간결과 내 간결이 다르다 — 숫자('결론 1줄 + 근거 3줄') · 금지어('~것 같습니다 금지') · 고정 포맷('표는 3열') 중 하나로 바꾸면 세 산출물이 같은 틀로 나온다",
        quote: "세 산출물이 제각각이면 규칙에 형용사만 있는 것"
      },
      {
        title: "예시 1개는 복사, 3개는 감옥",
        description: "지난 주 보고서를 지침에 통째로 붙이면 AI는 그 보고서 안에 갇힌다 — 숫자와 문장까지 베낀다. 지침에는 규칙(형식만), 예시는 프롬프트에. '항상 이 포맷' 템플릿 1개만 예외",
        quote: "지침엔 '항상 이렇게', 프롬프트엔 '이번엔 이렇게'"
      }
    ]
  },
  {
    ...
    subtitle: "중급반 3강. 매주 남긴 점수가 어디에 어떻게 남았는지 — 리더보드 한 장을 표·열·규칙·열쇠로 네 번 뜯는다. 데이터는 쌓이는 게 아니라 지켜지는 것",
    duration: "약 160분 (강의 140여 분 + 숙제 브리핑 + 휴식 10)",
    level: "중급반 3강 (14차 이어서)",
    framework: "창고 해부 4단",
    frameworkFull: "표(테이블)·열(컬럼)·규칙(제약·관계)·열쇠(보안)",
    heroQuote: "데이터는 화면 뒤에 쌓인 것이 아니라, 표와 규칙과 열쇠로 지켜지는 것이다",
    tagline: "중급반 3회: 구조를 그린다(12차) → 화면을 그린다(14차) → 데이터를 그린다(16차) — 숙제 3연쇄 「내 앱 설계 3종 세트」 완성",
    prerequisite: "14차 화면 해부 4단 · 화면도가 없어도 시작 가능 · 채점 플랫폼 미사용 — 강의 + 숙제(데이터도) · 코드는 한 장(표 만드는 문장)만 예외",

    promises: [
      "데이터를 표(한 표 = 한 종류의 사실)·열(열마다 들어갈 것이 정해져 있다)·규칙(표는 스스로를 지킨다)·열쇠로 나눠 보는 눈을 얻는다",
      "'표 두 장과 줄 하나' — 반복되면 표를 가르고 번호로 잇는다는 관계 감각, 그리고 열쇠 둘(비밀은 서버에만 · 공개 열쇠엔 문지기)의 원리를 12차 떡밥 그대로 갚는다",
      "내 앱의 데이터도(남길 것 → 표 → 열 → 줄 → 문지기 표)를 종이에 그려 구조도·화면도와 함께 「내 앱 설계 3종 세트」를 완성한다"
    ],

    beforeAfter: {
      title: "같은 채점 버튼을 본 세 개의 눈 — 창고판",
      before: {
        label: "Before (창고는 '점수가 저장되는 곳')",
        prompt: "점수를 저장하고 리더보드를 보여줘",
        result: "제목이 제출마다 40번 반복되고, 오타 하나에 세션이 둘로 갈라지고, 누구나 내 점수를 고칠 수 있는 앱"
      },
      after: {
        label: "After (4단 + 줄 하나 + 문지기)",
        prompt: "세션 표(코드 유일·모드 5종) + 제출 표(세션번호 → 세션.번호) / 읽기 O 쓰기 O 고치기 X 지우기 X / Claude 키는 서버 서랍에만",
        result: "표마다 열·규칙·문지기를 적을 수 있다 — 그게 곧 데이터 설계"
      }
    },

    curriculum: [
      { section: "Part 0 — 14차 한 장 복습 · 핵심 메시지", time: "15분", slides: "1~3" },
      { section: "Part 1 — 표와 열: 데이터가 사는 세 곳(주머니·손·창고) · 표(리더보드를 뒤집으면) · 정체 공개(코드 한 장) · 열(종류·필수·기본값) · 규칙 · 왜 표가 둘인가", time: "50분", slides: "4~10", highlight: true },
      { section: "Part 2 — 관계(표 두 장과 줄 하나) ⭐ · 창고에 하는 일 넷 · 읽기 한 문장(재제출은 줄이 늘어난다) · 색인", time: "31분", slides: "11~14", highlight: true },
      { section: "Part 3 — 열쇠 두 개(비밀·공개) · 문지기(표마다 네 가지 허락) · 만료와 실시간", time: "30분", slides: "15~17", highlight: true },
      { section: "Part 4 — 여정 ③ 창고판(3회 관통 완성) · 좋은 데이터의 원칙 5", time: "18분", slides: "18~19" },
      { section: "Part 5 — 숙제: 내 앱 데이터도 · 3종 세트가 겹쳐진다 · 다음 시즌 예고", time: "14분", slides: "20~23" }
    ],

    killerInsights: [
      {
        title: "표 두 장과 줄 하나가 데이터 설계의 90%",
        description: "세션 제목을 제출 줄마다 적으면 40번 반복되고, 고치면 40군데, 오타 하나면 세션이 둘로 갈라진다. 그래서 표를 가르고 — 제출 표의 「세션번호」가 세션 표의 번호를 가리키는 줄 하나로 다시 잇는다. 폴더(12차)·부품(14차)·표(16차), 같은 원리가 크기만 다르게",
        quote: "반복되면 가르고, 번호로 잇는다"
      },
      {
        title: "문지기 없는 공개 열쇠는 길에 떨어뜨린 열쇠",
        description: "창고 열쇠는 브라우저에 실려 나간다 — 리더보드를 그리려면 브라우저가 창고를 읽어야 하니까. 그런데도 내 점수를 못 고치는 건 열쇠 덕이 아니라 문지기 덕이다. 표마다 읽기·쓰기·고치기·지우기 네 칸을 정하면, 허락 안 한 일은 전부 거절된다. 쓰면 돈이 나가는 Claude 열쇠는 서버 서랍에만",
        quote: "12차 '열쇠는 서버에서만 — 원리는 16차에서'를 오늘 갚는다"
      }
    ]
  }
];
...
export const frameworks = [
  ...
  {
    name: "개발 지도 3층",
    subtitle: "개발 세계를 읽는 지도 — 지형·골목·문패 (12차 중급반 1강)",
    course: "12차 강의 (중급반 1강)",
    elements: [
      { code: "지", name: "지형", english: "Terrain", question: "화면·동작·데이터·연결의 실명은? — 프론트엔드·백엔드·DB·API는 각각 왜 존재하나?" },
      { code: "골", name: "골목", english: "Folders", question: "이 폴더는 왜 따로 있나? 내가 만든 것과 도구가 만든 것은 어디서 갈리나?" },
      { code: "문", name: "문패", english: "Files", question: "package.json·node_modules·.env·README·CLAUDE.md — 각 파일의 신분은?" }
    ]
  },
  {
    name: "화면 해부 4단",
    subtitle: "화면을 뜯어 보는 눈 — 뼈대·옷·움직임·부품 (14차 중급반 2강)",
    course: "14차 강의 (중급반 2강)",
    elements: [
      { code: "뼈", name: "뼈대", english: "HTML", question: "이 화면에 무슨 상자들이 있나? 상자 속 상자, 상자마다 이름표" },
      { code: "옷", name: "옷", english: "CSS", question: "그 상자는 무슨 색·크기·자리인가? 폰 옷과 PC 옷이 따로 있나?" },
      { code: "움", name: "움직임", english: "JavaScript", question: "누르면 무엇이 일어나나? 바뀌나·생기나·사라지나·다른 화면으로 가나?" },
      { code: "부", name: "부품", english: "Component", question: "두 번 이상 나오는 상자 묶음은? 빈칸으로 안 되는 차이가 있으면 부품을 가른다" }
    ]
  },
  {
    name: "창고 해부 4단",
    subtitle: "데이터를 뜯어 보는 눈 — 표·열·규칙·열쇠 (16차 중급반 3강)",
    course: "16차 강의 (중급반 3강)",
    elements: [
      { code: "표", name: "표", english: "Table", question: "이 앱이 남겨야 하는 사실은 몇 종류인가? 한 표 = 한 종류, 한 줄 = 사실 하나" },
      { code: "열", name: "열", english: "Column", question: "각 사실에 무엇을 적나 — 글자·숫자·시각·참/거짓·덩어리? 필수인가, 기본값이 있나?" },
      { code: "규", name: "규칙", english: "Constraint · Relation", question: "같은 값이 둘이면 안 되는 열은? 어느 표의 어느 열이 어느 표의 번호를 가리키나?" },
      { code: "쇠", name: "열쇠", english: "Security", question: "표마다 누가 읽고·쓰고·고치고·지우나? 비밀 열쇠는 서버 서랍에만 있나?" }
    ]
  }
];
...
export const courseDetails = [
  ...
  },
  {
        ...
        content: [
          {
            ...
            text: "11차의 성실함이 13차 결과물로 증명되는 구조다 — 화면 칸(폰인지 PC인지)을 제대로 채운 사람의 앱은 첫 실행부터 깨지지 않는다. 숙제는 하나: 빈 칸(특히 연결)을 채워 워크시트를 13차에 가져오기 — 잃어버려도 괜찮다, 13차 첫 8분에 다시 그린다."
          }
        ]
      },
    ],
    ...
    faqs: [
      {
        q: "왜 채점 플랫폼을 안 쓰나요?",
        a: "오늘의 산출물은 점수가 아니라 구조도 1장이기 때문입니다. 구조도는 정답이 하나가 아니라서 기계 채점보다 사람의 질문이 낫습니다 — 그래서 상호리뷰가 채점을 대신합니다. 13차·15차도 채점기 대신 claude.ai에 직접 실행한 결과(뜬 화면 / 세 산출물)가 피드백입니다."
      },
      {
        q: "소재를 못 정하겠어요.",
      ...
      {
        q: "소재를 다음 주에 바꿔도 되나요?",
        a: "권하지 않습니다. 오늘 그린 그림이 13차에 실제 앱으로 만들어지는 2주 서사라서, 소재를 바꾸면 그 연결이 끊깁니다. 크기가 문제라면 바꾸는 대신 자르세요 — 자른 것은 「이번엔 안 만들 것」에 적어두면 됩니다. (15차 '굳힌다'의 소재는 앱이 아니라 각자 매주 다시 하는 반복 업무입니다 — 앱은 한 번 만들면 끝나는 일이라 지침의 대상이 아닙니다.)"
      },
      {
        q: "초급반은 세 번으로 끝나나요?",
  ...
  {
    id: "course-12",
    heroMessage: "중급반은 만드는 날이 아니라 이해하는 날로 시작합니다. 10차에선 소스를 감췄지만, 12차엔 여러분이 매주 점수를 받던 그 채점기의 속 지도를 다 펼칩니다 — 폴더가 왜 그렇게 갈라졌는지, 파일 하나하나가 왜 그 자리에 있는지. 이미 다 해봤습니다. 오늘은 이름을 배웁니다.",
    promises: [
      "프론트엔드·백엔드·DB·API를 이름표가 아니라 '왜 존재하는지'로 이해한다 — 백엔드를 숨기는 이유 셋(비밀·신뢰·힘), DB가 엑셀과 다른 이유 셋(동시성·검색·규칙)",
      "채점기 레포의 루트와 src 다섯 골목을 읽고, 좋은 구조의 원칙 5로 내 앱 구조도를 스스로 검사한다",
      "채점 버튼의 3초를 지형의 눈으로 본다 — 14차에 화면, 16차에 창고(데이터)의 눈으로 두 번 더 본다"
    ],
    beforeAfterExample: {
      title: "Before / After — 같은 채점 버튼을 본 두 개의 눈",
      subtitle: "차이는 코드가 아니라 지도다",
      before: {
        label: "❌ 버튼을 누르는 사람",
        prompt: "채점하기를 누르면 점수가 나온다",
        result: "그 3초 동안 무슨 일이 어디서 일어나는지 설명할 수 없다 — 내 앱을 시킬 때도 '알아서 해줘'가 된다"
      },
      after: {
        label: "✅ 지도를 든 사람",
        prompt: "버튼[화면] → 화면 없는 골목 /api[연결] → 채점 기준+Claude[동작 — 열쇠는 서버에서만] → 결과 카드[화면] → 창고[데이터] → 리더보드",
        result: "폴더마다 이유를 적을 수 있다 — 그게 곧 설계"
      }
    },
    parts: [
      {
        title: "Part 1. 지형 — 개발 세계는 크게 어떻게 나뉘나",
        content: [
          {
            subtitle: "주소창의 여정 — 서버는 그림이 아니라 설계도를 보낸다",
            quote: "화면은 여러분의 폰이 그립니다.",
            text: "주소를 치면 요청이 가고, 서버는 '설계도'를 보내고, 그 설계도를 받아 그림을 그리는 건 브라우저(내 폰)다. 서버는 신비한 게 아니라 응답하는 일을 맡은, 안 꺼지는 그냥 컴퓨터 — 내 노트북도 서버가 될 수 있다(덮으면 가게가 닫힐 뿐). 이 한 문장이 프론트/백을 가르는 첫 감각이다.",
            tip: "HTTP·DNS·IP 같은 말은 쓰지 않는다 — 손님·주방·설계도로만."
          },
          {
            subtitle: "4겹의 실명 — 화면·동작·데이터·연결은 프론트엔드·백엔드·DB·API",
            table: {
              title: "레이어 4겹(7차)의 본명과 존재 이유",
              rows: [
                { axis: "화면 → 프론트엔드", question: "브라우저 안에서 실행되는 전부. UI(생김새) vs UX(경험). 코드가 전부 사용자에게 보인다 → 비밀을 둘 수 없다" },
                { axis: "동작 → 백엔드", question: "서버에서 실행. 숨기는 이유 셋 — 비밀(API 키)·신뢰(100점으로 바꿔 제출하면 그만)·힘(폰에서 채점 안 하는 이유)" },
                { axis: "데이터 → DB", question: "표(테이블)로 저장하는 전문 프로그램. 엑셀과 다른 셋 — 동시성·검색·규칙. 채점기의 창고는 폴더 밖(Supabase)에 있다" },
                { axis: "연결 → API", question: "프로그램끼리의 대화 규칙(주문서 양식). 채점기 서버는 주방이자 손님 — /api/score를 열고, Claude API에 주문한다" }
              ]
            }
          }
        ]
      ...
      {
        title: "Part 2. 골목과 문패 — 폴더는 왜 갈라졌고, 파일은 무슨 신분인가",
        content: [
          {
            subtitle: "루트 트리 — 내가 만든 건 절반뿐",
            text: "채점기 루트에는 재료 목록(package.json)·창고(node_modules)·조리 결과(.next)·열쇠 서랍(.env)·문지기(.gitignore)·문패 두 장(README.md 사람용·CLAUDE.md AI용)이 있다. 이 중 내가 직접 쓴 건 절반이고 나머지는 도구가 만든다. 손들기 퀴즈 — node_modules를 지워도 될까? 됩니다. 목록만 있으면 창고는 다시 산다.",
            quote: "AI는 매번 처음 출근한 직원이다 — 그래서 CLAUDE.md라는 문패가 있다."
          },
          {
            subtitle: "이름 정리 — 러시아 인형",
            text: "언어는 말, 라이브러리는 내가 부르는 부품 상자, 프레임워크는 나를 끼워 넣는 조립 키트. JavaScript(웹의 모국어) → TypeScript(약속을 얹음) → React(화면을 부품으로 조립하는 라이브러리) → Next.js(앱 전체를 짓는 프레임워크, 폴더 규칙까지 정함). 채점기는 Next.js로 지은 앱이고, 속은 React 부품이고, 부품은 TypeScript로 쓰였고, TS는 결국 JavaScript다.",
            tip: "내가 부르면 라이브러리, 나를 부르면 프레임워크."
          },
          {
            subtitle: "src 다섯 골목 — 폴더가 곧 주소",
            text: "app(주소 동네 — 페이지 + api 창구), components(화면 부품 — 레고), lib(동작 — 채점 기준·세션 처리), types(계약 — 주고받는 것의 약속), data(content.ts 225KB — 콘텐츠 데이터). app 폴더의 구조가 곧 주소가 된다 — [code]는 변하는 주소, api는 화면 없는 골목. 경계는 흐리다 — 태그가 둘 붙어도 된다.",
            quote: "채점기의 화면은 몇 개인가 — 폴더를 세면 답이 나온다."
          }
        ]
      },
      {
        title: "Part 3. 좋은 구조의 원칙 5 · 채점 버튼의 여정",
        content: [
          {
            subtitle: "원칙 5 — 이 강의가 남기는 판단 기준",
            table: {
              title: "좋은 구조의 원칙 5 (= 구조도 숙제 채점 기준)",
              rows: [
                { axis: "① 한 폴더 = 한 책임", question: "이유를 한 줄로 못 쓰는 폴더는 없어야 할 폴더" },
                { axis: "② 화면과 동작을 섞지 않는다", question: "섞으면 로직 고치다 화면이 깨진다 — 서로 인질" },
                { axis: "③ 주고받는 것은 계약으로", question: "types/ — 점수의 생김새를 약속 (2차 I/O 계약의 코드판)" },
                { axis: "④ 데이터와 코드를 섞지 않는다 ⭐", question: "강의 11개가 추가되는 동안 고친 파일은 대부분 content.ts 하나" },
                { axis: "⑤ 문패를 단다", question: "README(사람용) + CLAUDE.md(AI용) — 문서도 구조다" }
              ]
            }
          },
          {
            subtitle: "채점 버튼의 여정 — 수백 번 누른 그 버튼",
            text: "채점하기 버튼[화면] → /api/score[연결] → 채점 기준 + Claude[동작, 🔑 열쇠는 서버에서만] → 결과 카드[화면] → Supabase 저장[데이터] → 리더보드[화면]. 아까는 주소로 들어왔고 이번엔 버튼으로 들어왔다 — 이 여정이 그려지면 지도는 완성. 열쇠(.env)가 브라우저에 있었다면 모두가 API 키를 가져갈 수 있었다 — 원리는 16차에.",
            tip: "숙제 — 내 앱 구조도. 합격 기준 셋: 최상위 폴더 3~6개 · 모든 폴더에 '왜' 한 줄 · 4겹 태그. 설계지에 작성 순서 5단계와 완성 예시(점심 메뉴 뽑기)가 들어 있다."
          }
        ]
      },
    ],
    habits: [
      {
        title: "폴더마다 '왜' 한 줄",
        description: "새 프로젝트 폴더를 열면 '이 폴더는 왜 따로 있나?'를 한 줄로 적어 보는 습관 — 못 쓰면 없어야 할 폴더"
      },
      {
        title: "내가 만든 것 / 도구가 만든 것 가르기",
        description: "레포를 열면 package.json·node_modules·.env·.gitignore부터 찾아 '이건 도구 것'이라고 표시하는 습관 — 내가 손댈 파일은 절반뿐"
      }
    ],
    checkCard: [
      { code: "지", name: "지형", question: "이 기능은 브라우저에서 도나, 서버에서 도나? 비밀·신뢰·힘 중 하나에 걸리면 서버다" },
      { code: "골", name: "골목", question: "이 파일은 어느 골목(app·components·lib·types·data)에 자리가 있나? 그 이유는?" }
    ],
    conclusion: "오늘 우리는 아무것도 만들지 않았습니다. 대신 지도를 얻었습니다 — 모든 파일에는 자리가 있고, 그 자리에는 이유가 있다.\n\n같은 3초를 14차엔 화면의 눈으로, 16차엔 창고의 눈으로 봅니다 — 화면은 무엇으로 만들어지고, 점수와 이름은 어디서 오고 어디에 남는지. 세 장을 모으면 「내 앱 설계 3종 세트」, 그다음에 진짜로 만듭니다.",
    challenge: "숙제는 내 앱 구조도(설계지 4쪽) — 종이와 펜이면 충분합니다. 작성 순서 5단계와 완성 예시(점심 메뉴 뽑기)가 종이 안에 있으니 그 형식을 빌려 그리세요. 폴더마다 '왜' 한 줄이 채점 기준입니다.",
    faqs: [
      {
        q: "왜 코드를 안 보여주나요?",
        a: "개발이 처음인 사람에게 코드는 정보가 아니라 소음이기 때문입니다. 지도가 먼저 생겨야 코드가 '아, 이게 그 골목이구나'로 읽힙니다. 코드는 다음 시즌에 — 14차에 딱 한 장만 예외로 봅니다."
      },
      {
        q: "중급반은 세 번으로 끝나나요?",
        a: "아니요, 중급반은 계속 이어집니다. 먼저 세 번의 계획(구조도·화면도·데이터도)이 잡혀 있고, 세 장이 모이면 「내 앱 설계 3종 세트」로 다음 시즌(진짜 만들기)의 입구가 됩니다."
      },
      {
        q: "채점 플랫폼은 왜 안 쓰나요?",
        a: "이 회차의 산출물은 점수가 아니라 종이 한 장(구조도)이기 때문입니다. 정답이 하나가 아닌 설계는 기계 채점보다 원칙 5로 스스로 검사하는 편이 낫습니다."
      }
    ]
  },
  {
    id: "course-13",
    heroMessage: "지난주에 약속했죠 — 오늘 그린 그림을 다음 시간엔 화면에 띄운다고. 오늘 그거 합니다. 백지에서 시작하는 사람은 한 명도 없습니다. 네 칸을 변환표 4줄에 따라 문장으로 옮겨 적고, claude.ai에 붙여넣고, 뜬 화면과 구조도를 비교해 문장 하나를 고쳐 다시 띄웁니다. 프롬프트는 창작이 아니라 번역입니다.",
    promises: [
      "구조도 네 칸을 변환표 4줄로 옮겨 250~500자 완성형 프롬프트를 만든다 — 칸당 1~2문장, 조립 순서는 역할→목적→맥락→제약→출력",
      "완성형을 claude.ai에 직접 실행해 내 앱이 뜨는 순간을 본다 — 피드백은 점수가 아니라 뜬 화면 그 자체",
      "화면과 구조도의 차이(비교 3질문)에서 다음에 고칠 문장을 찾아 v2까지 간다 — 실력은 두 번째 실행에서 는다"
    ],
    beforeAfterExample: {
      title: "Before / After — 같은 메모앱 구조도, 두 개의 프롬프트",
      subtitle: "차이는 문장력이 아니라 네 칸이 다 들어갔는가",
      before: {
        label: "❌ 백지에서 짓기",
        prompt: "메모앱 만들어줘. 예쁘게.",
        result: "PC 기준으로 나와 폰에서 깨지고, 껐다 켜면 사라지고, 앱 대신 설명문이 온다"
      },
      after: {
        label: "✅ 네 칸을 번역하기",
        prompt: "너는 10년차 모바일 UI 디자이너야. 메모를 빨리 적고 다시 찾아보려는 30~40대 직장인이 쓸 간단한 메모앱을 만들어줘. 폰 세로 화면 기준이야. 화면은 두 개 — 목록과 작성. 저장 버튼 없이 자동 저장되고, 껐다 켜도 남아야 해. 흰 배경, 이모지 금지. 로그인 없이, 나 혼자. 한 페이지 HTML 한 파일로 만들어줘.",
        result: "첫 실행부터 작동하는 앱 — 화면 칸이 디바이스 한 줄로 꽂힌 덕"
      }
    },
    parts: [
      {
        title: "Part 1. 쓴다 — 구조도를 프롬프트로 옮기는 법",
        content: [
          {
            subtitle: "프롬프트는 창작이 아니라 번역이다",
            text: "13차는 백지에서 시작하지 않는다 — 11차에 그린 네 칸을 변환표 4줄에 따라 문장으로 옮겨 적고(칸당 1~2문장), 역할→목적→맥락→제약→출력 순서로 이어 붙이면 250~500자 완성형 프롬프트가 된다. 이번 수업은 채점기를 쓰지 않는다: 완성형을 claude.ai에 직접 실행해 미리보기에 내 앱이 뜨는 것을 확인한다 — 피드백은 점수가 아니라 뜬 화면 그 자체다. 노트북이 없어도 폰이면 충분하다(claude.ai 앱/모바일웹)."
          },
          {
            subtitle: "다섯 칸으로 조립한다 — 역할 · 목적 · 맥락 · 제약 · 출력",
            table: {
              title: "좋은 묘사의 다섯 칸 (조립 순서 그대로)",
              rows: [
                { axis: "역할 — 어떤 전문가 시점인가", question: "\"너는 10년차 모바일 UI 디자이너야\" (경력 + 세부 분야)" },
                { axis: "목적 — 누가 왜 쓰는 앱인가", question: "구조도 맨 위에 쓴 \"내가 만들 것 한 문장\"이 그대로 들어간다" },
                { axis: "맥락 — 누가 · 어떤 기기에서 · 언제", question: "★ 디바이스를 안 적으면 PC 기준으로 나와 폰에서 깨진다 — 화면 칸을 보라" },
                { axis: "제약 — 디자인 · 분량 · 기술 · 금지", question: "\"흰 배경, 한 화면에, 외부 라이브러리 없이, 이모지 금지\" — 넷 중 셋 이상" },
                { axis: "출력 — 파일 종류 + 화면 구성", question: "마지막 한 줄 고정: \"한 페이지 HTML 한 파일로 만들어줘\"" }
              ]
            }
          },
          {
            subtitle: "엔진 — 쏘고(실행) → 보고(화면) → 고친다(프롬프트)",
            text: "첫 실행(v1)은 완성도 불문 — 화면이 떠야 뭘 고칠지 보인다. 화면 옆에 구조도를 놓고 세 가지만 비교한다: ① 그렸는데 화면에 없는 것(그 칸의 문장이 약한 것 — 보강) ② 폰에서 열면 깨지는가(디바이스 한 줄부터) ③ 안 그렸는데 있는 것(살리거나 금지 제약으로). 규칙은 두 개 — 대화로 고치지 말고 프롬프트를 고쳐 새 대화에서 다시 실행할 것(오늘의 연습은 앱이 아니라 프롬프트), 한 번에 한 가지만 고칠 것(뭐가 화면을 바꿨는지 알 수 있게). 실력은 두 번째 실행에서 는다."
          }
        ]
      }
    ],
    habits: [
      {
        title: "칸부터 보고 문장 쓰기",
        description: "프롬프트를 쓰기 전에 구조도 네 칸을 먼저 놓고, 칸마다 '변환표에서 어디로 가지?'를 묻는 습관 — 백지에서 시작하지 않는다"
      },
      {
        title: "디바이스 한 줄 먼저",
        description: "어떤 앱 프롬프트든 '폰 세로 화면' 또는 'PC 브라우저' 한 줄을 맨 앞쪽에 박는 습관 — 없으면 PC 기준으로 나와 폰에서 깨진다"
      },
      {
        title: "대화 말고 프롬프트를 고치기",
        description: "화면이 마음에 안 들면 이어지는 대화로 고치지 않고 프롬프트를 고쳐 새 대화에서 다시 실행하는 습관 — 앱이 아니라 프롬프트가 는다"
      }
    ],
    checkCard: [
      { code: "역", name: "역할", question: "경력 + 세부 분야 한 줄이 있나? (과장 없이)" },
      { code: "W", name: "Where", question: "디바이스 한 줄(폰 세로 / PC)이 있나?" },
      { code: "제", name: "제약", question: "디자인·분량·기술·금지 중 셋 이상 있나?" },
      { code: "종", name: "종결", question: "마지막 줄이 '한 페이지 HTML 한 파일로 만들어줘'인가?" }
    ],
    conclusion: "오늘 네 칸이 화면이 됐습니다 — 지난주 그 종이가 이겁니다.\n\n그리고 한 번으로 끝나지 않았습니다. 첫 화면을 보고, 구조도와 비교하고, 문장 하나를 고쳐 두 번째 화면을 띄웠습니다. 실력은 두 번째 실행에서 늡니다.\n\n다음 시간엔 방향이 조금 바뀝니다 — 한 번 만들고 끝나는 앱이 아니라, 매주 다시 하는 일을 AI에게 한 번만 설명해두는 법. 그게 지침입니다.",
    challenge: "오늘 만든 앱을 일주일 실제로 써보세요. 쓰다가 불편한 점을 찾아 프롬프트를 고쳐 새 버전을 만들어보면 더 좋습니다 — 무엇을 고쳤는지 한 줄만 메모해두세요. 15차는 가져올 자료 없이 시작합니다.",
    faqs: [
      {
        q: "11차 워크시트를 잃어버렸어요.",
        a: "문제없습니다. 수업 첫 8분에 전원이 오늘 워크시트 2쪽에 구조도를 다시 그립니다 — 한 번 그렸다면 머릿속에 있습니다. 11차에 못 온 분은 소재 리스트에서 제일 작은 것을 골라 즉석에서 그리면 됩니다."
      },
      {
        q: "노트북이 없는데 실행할 수 있나요?",
        a: "폰이면 충분합니다 — claude.ai 앱이나 모바일웹으로 실행과 미리보기가 전부 됩니다. 250~500자는 폰 타이핑(음성 입력도 가능)으로 충분하고, 폰 세로 화면 소재는 자기 폰에서 여는 게 곧 Where 검증입니다."
      },
      {
        q: "왜 채점기를 안 쓰나요?",
        a: "오늘의 피드백은 점수보다 정직합니다 — 뜬 화면 그 자체이기 때문입니다. 그렸는데 없으면 그 칸의 문장이 약한 것이고, 폰에서 깨지면 디바이스 한 줄이 없는 것이고, 안 그렸는데 있으면 AI가 채운 것입니다. 화면이 채점표입니다."
      },
      {
        q: "첫 화면이 엉망인데요.",
        a: "첫 화면은 성적이 아니라 재료입니다. 화면 옆에 구조도를 놓고 비교 3질문만 던지면 다음에 고칠 문장이 보입니다. 한 번에 한 가지만 고쳐 새 대화에서 다시 실행하세요 — 뭐가 화면을 바꿨는지 알 수 있게."
      }
    ]
  },
  {
    id: "course-14",
    heroMessage: "12차엔 지도를 얻었습니다. 오늘은 그 지도의 「화면」 폴더 안으로 들어갑니다 — 매주 눌렀던 채점 화면 한 장을 뼈대·옷·움직임·부품으로 네 번 뜯습니다. 코드는 띄우지 않습니다, 딱 한 장만 빼고. 화면은 한 장의 그림이 아니라, 부품과 상태의 조립입니다.",
    promises: [
      "화면을 뼈대(HTML)·옷(CSS)·움직임(JS)·부품(컴포넌트)으로 나눠 보는 눈을 얻는다 — 같은 뼈대에 다른 옷, 누르면 일어나는 일",
      "'화면 하나는 그림 여러 장'(비어 있음·기다림·성공·실패)이라는 상태 감각을 갖고, AI에게 화면을 시키기 전에 빠뜨리는 세 장을 먼저 적는다",
      "내 앱의 화면도(화면 목록·이동·상자·부품·상태 4칸)를 종이에 그려 나간다 — 16차 데이터도의 첫 재료"
    ],
    beforeAfterExample: {
      title: "Before / After — 같은 채점 버튼을 본 두 개의 눈 (화면판)",
      subtitle: "차이는 성공 화면 한 장만 상상하는가, 네 장을 세는가",
      before: {
        label: "❌ 성공 화면만 상상",
        prompt: "채점 결과가 카드로 예쁘게 나온다",
        result: "기다림 화면이 없어 버튼을 두 번 누르고 두 번 채점된다 — 실패하면 아무 말도 없다"
      },
      after: {
        label: "✅ 4단 + 상태 4장",
        prompt: "버튼[움직임] → '채점 중…' 잠김 + 회색 상자 셋[기다림] → 결과 카드[부품] → 등록 카드[하단 고정] → 리더보드[이동] / 실패 → 빨간 알림 + 다음 행동",
        result: "화면마다 상태를 적을 수 있다 — 그게 곧 화면 설계"
      }
    },
    parts: [
      {
        title: "Part 1. 삼형제 — 뼈대 · 옷 · 움직임",
        content: [
          {
            subtitle: "서버가 보낸 설계도는 세 장이었다",
            quote: "화면은 한 장의 그림이 아니라, 부품과 상태의 조립이다.",
            text: "12차 여정 ①의 '설계도'는 사실 세 장이다 — 뭐가 있는지(뼈대·HTML), 어떻게 생겼는지(옷·CSS), 누르면 뭐가 일어나는지(움직임·JavaScript). 폰은 세 장을 겹쳐 한 화면을 그린다. 그래서 같은 세 장을 받아도 폰과 PC의 화면이 다를 수 있다.",
            tip: "이 수업은 코드를 띄우지 않는다 — 딱 한 장(정체 공개), 상자 여섯 개를 아홉 줄로 대조하는 장면만 예외. 나머지는 상자 그림(목업)으로만."
          },
          {
            subtitle: "화면 해부 4단 — 채점 결과 카드 한 장을 네 번 다르게 본다",
            table: {
              title: "뼈대 · 옷 · 움직임 · 부품",
              rows: [
                { axis: "뼈대 (HTML)", question: "화면은 상자 속 상자 — 모든 것은 상자고, 상자마다 이름표(제목·문단·버튼·입력칸·목록·카드). 결과 카드 = 카드 > 숫자·배지·요소 행·버튼" },
                { axis: "옷 (CSS)", question: "같은 뼈대에 다른 옷 — 색·크기·자리·간격. 등급 배지 하나에 S 호박·A 초록·B 파랑·C 회색·D 주황·F 빨강 여섯 벌. 반응형 = 폰 옷과 PC 옷" },
                { axis: "움직임 (JavaScript)", question: "누르면 일어난다 — 사건 → 반응 → 상자가 바뀐다·생긴다·사라진다. 채점 버튼이 하는 일 셋: 글자가 '채점 중…'으로 바뀌고 잠긴다 / 회색 상자 셋이 나타난다 / 결과 카드가 생기고 스크롤된다" },
                { axis: "부품 (컴포넌트)", question: "반복되는 상자 묶음에 이름을 붙인 것 — 다섯 번 그리지 않고 한 번 만든다. 부품엔 빈칸(글자·색·크기)이 있어 하나로 여럿을 만든다. 빈칸으로 안 되는 차이가 있으면 부품을 가른다(채점기가 5종인 이유)" }
              ]
            }
          },
          {
            subtitle: "UI vs UX — 생김새와 겪는 것",
            text: "UI는 뼈대+옷(배지 색·큰 숫자·둥근 카드), UX는 움직임+상태+이동(채점 끝나면 등록 카드가 화면 하단에 고정 · 결과 위치로 자동 스크롤 · 세션 모드에선 결과 끝 버튼을 숨겨 '끝났다' 신호가 등록 버튼을 가리지 않게). 둘은 따로 좋고 따로 나쁘다 — 예쁜데 불편한 앱과 못생겼는데 편한 앱이 둘 다 존재하는 이유. 화면도 절반은 사온 것이다 — 기성 부품(ui/ 8개)·옷장(Tailwind)·움직임 상자(framer-motion)."
          }
        ]
      },
      {
        title: "Part 2. 상태와 이동 — 화면 하나는 그림 여러 장이다",
        content: [
          {
            subtitle: "상태 4장 — 오늘의 승부처",
            table: {
              title: "채점 화면의 네 장",
              rows: [
                { axis: "① 비어 있음 (입력 전)", question: "회색 안내문 + '최소 30자' 빨간 안내 + 잠긴 버튼" },
                { axis: "② 기다림 (누른 뒤)", question: "버튼 '채점 중…'(잠김) + 회색 뼈대 상자 셋 — '받았어요'라는 대답. 없으면 두 번 누르고 두 번 채점된다" },
                { axis: "③ 성공 (결과 도착)", question: "결과 카드 6장 + 다음 행동 버튼 — 사람은 이 한 장만 상상한다" },
                { axis: "④ 실패 (안 됐을 때)", question: "빨간 알림 '채점에 실패했습니다' + 다음에 뭘 하면 되는지" }
              ]
            },
            quote: "AI에게 화면을 시킬 때 사람이 가장 많이 빠뜨리는 세 장 — 비어 있을 때, 기다릴 때, 실패했을 때."
          },
          {
            subtitle: "이동 — 화면 사이의 길",
            text: "채점기 화면은 7개(12차엔 6개 — 자료실이 생겨 늘었다. 화면은 늘어난다). 홈 → 실습 / 홈 → 호스트 → 리더보드 / 참가 → 채점 → 등록 → 리더보드. 버튼마다 '어디로'가 정해져 있다. 도착 화살표가 없는 화면은 존재하지 않는 화면이고, 돌아오는 길이 없는 화면은 감옥이다. 상태 변화(같은 화면이 바뀜)와 이동(다른 화면으로 감)은 다른 일 — 채점 버튼은 상태를 바꾸고, 등록 버튼은 이동시킨다."
          },
          {
            subtitle: "좋은 화면의 원칙 5 · 숙제: 내 앱 화면도",
            table: {
              title: "좋은 화면의 원칙 5 (= 화면도 숙제 채점 기준)",
              rows: [
                { axis: "① 한 화면 = 한 목적", question: "실습은 채점만, 리더보드는 순위만" },
                { axis: "② 반복되면 부품", question: "버튼·배지·카드는 부품 하나를 여러 곳에서" },
                { axis: "③ 상태를 빠뜨리지 않는다 ⭐", question: "비어 있음 · 기다림 · 실패 — 기다림이 없으면 두 번 채점된다" },
                { axis: "④ 폰 먼저", question: "같은 뼈대, 폰 옷부터 — 4차 Where의 원리" },
                { axis: "⑤ 보이는 것과 하는 것을 나눈다", question: "뼈대·옷 / 움직임 — 12차 원칙 ②의 화면판" }
              ]
            },
            text: "숙제 — 내 앱 화면도(A4 4쪽, 작성 순서 5단계 + 완성 예시 내장). 합격 기준 셋: 화면 목록 + 이동 화살표 / 대표 화면 1장의 상자 그림 + 부품 동그라미 + '왜 부품인가' / 상태 4칸 중 3칸 이상. 4쪽 맨 아래 「이 화면에 보이는 데이터」 칸이 16차 첫 재료다 — 점수 87, 등급 A, 리더보드의 이름은 화면이 만든 게 아니라 창고에서 온 것. 창고 속은 16차에."
          }
        ]
      }
    ],
    habits: [
      {
        title: "화면을 상자로 세기",
        description: "어떤 앱이든 화면을 보면 상자를 세고, 두 번 이상 나오는 상자에 동그라미 치는 습관 — 부품이 보이기 시작한다"
      },
      {
        title: "비어 있을 때·기다릴 때·실패했을 때 그리기",
        description: "AI에게 화면을 시키기 전에 성공 화면 말고 세 장을 먼저 적는 습관 — 기다림 화면이 없으면 두 번 눌린다"
      },
      {
        title: "버튼마다 '어디로' 적기",
        description: "화면도를 그릴 때 버튼마다 상태를 바꾸는지 다른 화면으로 가는지 적는 습관 — 도착 화살표 없는 화면은 존재하지 않는 화면"
      }
    ],
    checkCard: [
      { code: "뼈", name: "뼈대·옷", question: "상자 속 상자를 다 셌나? 같은 뼈대에 폰 옷부터 입혔나?" },
      { code: "부", name: "부품", question: "두 번 이상 나오는 상자에 이름을 붙였나? 빈칸은 무엇인가?" },
      { code: "상", name: "상태", question: "비어 있음·기다림·성공·실패 네 장 중 세 장 이상 적었나?" },
      { code: "이", name: "이동", question: "버튼마다 '어디로'가 있나? 돌아오는 길 없는 화면은 없나?" }
    ],
    conclusion: "12차에 얻은 지도의 화면 폴더를 오늘 열었습니다. 화면은 한 장의 그림이 아니라 부품과 상태의 조립이고, 매주 눌렀던 그 버튼은 화면을 세 번 바꿉니다.\n\n같은 3초를 16차엔 창고의 눈으로 봅니다 — 점수 87, 등급 A, 리더보드의 이름은 화면이 만든 게 아니라 창고에서 온 것입니다. 창고 속은 16차에.",
    challenge: "숙제는 내 앱 화면도(화면도 4쪽) — 종이와 펜이면 충분합니다. 합격 기준 셋: 화면 목록 + 이동 화살표 / 대표 화면 1장의 상자 그림 + 부품 동그라미 / 상태 4칸 중 3칸 이상. 4쪽 맨 아래 「이 화면에 보이는 데이터」 칸을 꼭 채워 16차에 가져오세요 — 데이터도의 첫 재료입니다.",
    faqs: [
      {
        q: "왜 코드를 한 장만 보여주나요?",
        a: "4단의 눈이 먼저 생겨야 코드가 '아, 이게 그 상자구나'로 읽히기 때문입니다. 딱 한 장 — 상자 여섯 개를 아홉 줄로 대조하는 정체 공개 장면만 예외로 두었습니다. 나머지는 다음 시즌에."
      },
      {
        q: "구조도를 못 그렸는데 화면도를 그릴 수 있나요?",
        a: "됩니다. 화면도는 구조도 없이도 시작할 수 있게 만들었습니다 — 2쪽 완성 예시(점심 메뉴 뽑기) 소재로 시작하거나, 지금 머릿속의 화면 3개를 새로 정해도 됩니다."
      },
      {
        q: "우리 앱은 화면이 하나뿐인데요.",
        a: "한 화면이어도 상태는 네 장입니다 — 비어 있을 때, 기다릴 때, 성공했을 때, 실패했을 때. 화면도 4쪽의 상태 4칸이 숙제의 본체입니다."
      },
      {
        q: "채점 플랫폼은 왜 안 쓰나요?",
        a: "오늘의 산출물은 점수가 아니라 종이 한 장(화면도)이기 때문입니다. 정답이 하나가 아닌 설계는 기계 채점보다 좋은 화면의 원칙 5로 스스로 검사하는 편이 낫습니다."
      }
    ]
  },
  {
    id: "course-15",
    heroMessage: "초급반 세 번째 시간, 오늘은 준비물이 없습니다. 지난 두 시간은 앱 하나를 그리고 띄웠죠 — 한 번 만들면 끝나는 일이었습니다. 오늘은 반대입니다. 매주 다시 하는 일을 AI에게 한 번만 설명해두는 법. 재료만 바뀌는 일은 지침이 됩니다.",
    promises: [
      "지침이 되는 일과 프롬프트로 충분한 일을 판별 3조건(주기·형식·재료)으로 가른다 — 앱은 0개, 주간 보고는 3개",
      "프롬프트 5요소를 지침 I·M·R·K·O로 옮겨 각자의 「○○ 작업실」 지침 한 페이지를 쓴다 — 규칙은 형용사 대신 숫자·금지어·고정 포맷으로",
      "지침을 claude.ai에 등록하고 서로 다른 재료 3개를 넣어 세 산출물이 같은 틀로 나오는지 본다 — 흔들린 줄 하나를 고쳐 두 번째 시험까지"
    ...
    beforeAfterExample: {
      title: "Before / After — 같은 한 줄, 두 곳에 (강사 데모 「강의 기획 작업실」)",
      subtitle: "요청은 똑같이 한 줄 — 차이는 미리 써둔 한 페이지",
      before: {
        label: "❌ 지침 없는 새 대화",
        prompt: "다음 주 초급반: 지침",
        result: "'어떤 초급반인가요? 지침은 어떤 형태?' 되묻거나, 산문으로 길게, 시간 배분 없음 — 매번 이 상태에서 다시 설명해야 한다"
      },
      after: {
        label: "✅ 지침이 등록된 프로젝트",
        prompt: "다음 주 초급반: 지침 (똑같이 한 줄)",
        result: "개요표 → 타임라인(분 단위) → 리스크표 → 산출물 목록, 늘 쓰던 순서로. 표는 3열, 강의 60% 이상, 모르는 건 [확인 필요]. 재료를 바꿔도 틀이 같다"
      }
    },
    parts: [
      {
        title: "Part 1. 굳힌다 — 반복을 지침으로",
        content: [
          {
            subtitle: "재료만 바뀌는 일은 지침이 된다",
            quote: "프롬프트는 주문, 지침은 가게 매뉴얼.",
            text: "13차의 앱은 프롬프트 한 방으로 끝나는 일이었다 — 그 프롬프트를 다음 주에 또 쓰지는 않는다. 15차의 소재는 반대다: 매주 다시 하는 일(주간 보고·강의 기획·원고·회의록 정리). 그때마다 \"너는 ○○ 전문가야, 형식은 이렇게, 말투는 이렇게\"를 다시 치는 것이 반복이고, 그 반복을 매 대화의 맨 앞에 자동으로 붙는 한 페이지로 옮기는 것이 지침이다. 지침이 되는 일인지는 세 질문으로 판별한다 — 주 1회 이상 다시 하나(주기), 결과물의 틀이 매번 같은가(형식), 바뀌는 건 재료뿐인가(재료). 셋 다 통과하면 지침, 하나라도 탈락하면 프롬프트로 충분하다.",
            tip: "지난 프롬프트에서 한 번도 안 바뀐 문장 — \"폰 세로\", \"HTML 한 파일\" — 그게 이미 매뉴얼감이었다."
          },
          {
            subtitle: "다섯 칸의 상시판 — 프롬프트 5요소가 지침 I·M·R·K·O가 된다",
            table: {
              title: "변환표 — 프롬프트에서 지침으로",
              rows: [
                { axis: "역할 → I 정체성", question: "+ 이름 + 성격 2~3개 — 대화가 길어져도 캐릭터가 안 흔들리게 (\"세계 최고·천재\"는 오히려 톤을 흔든다)" },
                { axis: "목적 → M 임무", question: "이번 한 번 → 주로 하는 일 2~3개 + 범위 밖 요청 처리 한 줄 (\"뭐든 다 해주는 AI는 뭐 하나 제대로 못 한다\")" },
                { axis: "제약 → R 규칙 ★", question: "이번 조건 → 항상 지키는 방식. 형용사 대신 숫자 · 금지어 · 고정 포맷 — \"해석의 여지가 있는 규칙은 작동하지 않는다\"" },
                { axis: "맥락 → K 지식", question: "매번 설명하던 배경을 한 번 올려두는 자료 — 비밀번호·개인정보·기밀은 넣지 않는다" },
                { axis: "출력 → O 출력", question: "이번 형식 → 매번 나오는 기본 포맷: 순서 · 섹션 · 길이, 헤더 고정" }
              ]
            },
            text: "초심자가 제일 먼저 빠지는 함정은 예시다 — 지난 주 보고서를 지침에 통째로 붙이면 AI는 그 보고서 안에 갇힌다(숫자·문장까지 베낀다). 예시 1개는 복사, 3개는 감옥. 지침에는 규칙(형식만), 예시는 프롬프트에."
          },
          {
            subtitle: "엔진 — 박고(등록) → 재료 셋 넣고(시험) → 흔들린 줄을 고친다",
            text: "채점기를 쓰지 않는다. 각자의 「○○ 작업실」 지침을 claude.ai 프로젝트 지침(또는 대화 맨 앞)에 등록하고, 서로 다른 재료 3개를 한 줄씩 넣어 세 산출물이 같은 틀로 나오는지 본다 — 피드백은 점수가 아니라 일관성이다. 세 산출물을 지침 옆에 놓고 비교 3질문: ① 재료 한 줄에 되묻거나 엉뚱하다(지식·임무가 비었다) ② 셋이 제각각이다(규칙이 형용사다 — 숫자로) ③ 안 시킨 걸 매번 한다(금지 규칙 한 줄, 또는 예시를 뺀다). 한 줄만 고쳐 다시 시험한다. 지침은 세 번째 재료에서 증명된다."
          }
        ]
      }
    ],
    habits: [
      {
        title: "세 번 반복하면 지침으로",
        description: "AI에게 같은 설명을 세 번째 하고 있다면 멈추고 판별 3조건을 묻는 습관 — 주 1회 이상? 틀이 같은가? 재료만 바뀌나?"
      },
      {
        title: "형용사를 숫자로",
        description: "'간결하게·보기 좋게·전문적으로'를 쓸 때마다 '몇 줄? 몇 열? 무엇을 금지?'로 바꾸는 습관 — 해석의 여지가 있는 규칙은 작동하지 않는다"
      },
      {
        title: "재료 셋으로 시험하기",
        description: "지침을 고치면 재료 하나로 만족하지 않고 세 개를 넣어보는 습관 — 하나 잘 나온 건 우연일 수 있고, 셋이 같은 틀이면 굳은 것"
      }
    ],
    checkCard: [
      { code: "I", name: "정체성", question: "이름 + 역할 + 성격 2~3개가 있나? (세계 최고·천재 없이)" },
      { code: "M", name: "임무", question: "주로 하는 일 2~3개 + 범위 밖 처리 한 줄이 있나?" },
      { code: "R", name: "규칙", question: "형용사가 0개인가? 숫자·금지어·고정 포맷으로만 썼나?" },
      { code: "K", name: "지식", question: "매번 설명하던 배경이 들어갔나? 비밀번호·개인정보는 없나?" },
      { code: "O", name: "출력", question: "순서·섹션·길이를 헤더로 고정했나?" }
    ],
    conclusion: "지침은 세 번째 재료에서 증명됩니다. 하나 잘 나온 건 우연일 수 있고, 셋이 같은 틀이면 굳은 겁니다. 오늘 셋이 흔들린 분들 — 실패가 아니라 고칠 줄이 보인 겁니다.\n\n세 시간을 돌아보면 — 11차에 그렸고, 13차에 썼고, 오늘 굳혔습니다. 이제 손에 구조도, 프롬프트, 지침이 한 벌 있습니다. 앱은 프롬프트로, 매주 하는 일은 지침으로.\n\n초급반은 계속됩니다.",
    challenge: "선택 숙제 하나 — 오늘 만든 지침으로 다음 주 실제 업무를 한 번 하고, 흔들린 줄 하나를 고쳐보세요. 무엇을 고쳤는지 한 줄만 메모해두면 됩니다. 지침은 수업이 아니라 실전에서 굳습니다.",
    faqs: [
      {
        q: "13차 앱을 지침으로 만들면 안 되나요?",
        a: "그 앱, 다음 주에 또 만드시나요? 안 만들죠 — 앱은 프롬프트 한 방으로 끝나는 일이라 판별 3조건을 0개 통과합니다. 대신 앱을 매주 소개하는 글을 쓴다면 그건 소재가 됩니다. 지침의 대상은 앱이 아니라 일입니다."
      },
      {
        q: "반복 업무가 안 떠올라요 (학생·주부·비직장인).",
        a: "'매주 다시 하는 것'이면 전부 소재입니다 — 주간 식단표, 독서 노트, 모임 공지, 아이 알림장 답장, 운동 기록, SNS 게시글. 강사가 업무 6개 + 비업무 6개 소재 리스트를 드립니다. 제일 자주 하는 걸로 고르세요."
      },
      {
        q: "무료 플랜인데 프로젝트 지침이 되나요?",
        a: "됩니다 (프로젝트는 무료 플랜에도 제공). 혹시 안 되면 대화 맨 앞에 지침을 붙이고 한 줄 띄운 뒤 재료를 쓰면 같은 효과입니다 — 세 대화 모두 같은 지침을 앞에 붙이면 됩니다. 그래도 안 되면 짝 계정."
      },
      {
        q: "지난 주 보고서를 지침에 붙이면 안 되나요?",
        a: "예시의 함정입니다 — 지침에 예시를 넣으면 AI가 그 안에 갇혀 숫자와 문장까지 베낍니다. 지난 보고서에서 형식만 꺼내 규칙으로 옮기세요('결론 1줄 · 표 3열 · 계획 3줄'). 본문은 빼고, '이번엔 이런 느낌으로'는 프롬프트에."
      },
      {
        q: "세 산출물이 제각각이에요.",
        a: "예고했던 그거예요 — 규칙에 형용사만 있는 겁니다. 워크시트 2쪽 체크리스트에서 '간결하게·보기 좋게' 하나만 골라 숫자로 바꾸세요('결론 1줄 + 3항목', '표 3열'). 한 줄만 고쳐 재료 하나로 다시 시험하면 됩니다."
      }
    ]
  },
  {
    id: "course-16",
    heroMessage: "12차에 지도를 얻었고, 14차에 화면을 뜯었습니다. 오늘은 그 지도의 마지막 동네 — 창고 — 안으로 들어갑니다. 여러분이 매주 남긴 점수가 지금도 표 한 장의 줄 하나로 남아 있습니다. 그 줄을 열어 열 하나하나에 이름을 붙입니다. 코드는 오늘도 딱 한 장. 데이터는 화면 뒤에 쌓인 것이 아니라, 표와 규칙과 열쇠로 지켜지는 것입니다.",
    promises: [
      "데이터를 표(한 표 = 한 종류의 사실)·열(열마다 들어갈 것이 정해져 있다)·규칙(표는 스스로를 지킨다)·열쇠(열쇠 둘과 문지기)로 나눠 보는 눈을 얻는다",
      "'표 두 장과 줄 하나' — 반복되면 표를 가르고 번호로 잇는 관계 감각을 갖고, AI에게 앱을 시키기 전에 표·열·문지기를 먼저 적는다",
      "내 앱의 데이터도(남길 것 → 표 → 열 → 줄 → 문지기 표)를 종이에 그려 구조도·화면도와 함께 「내 앱 설계 3종 세트」를 완성한다"
    ],
    beforeAfterExample: {
      title: "Before / After — 같은 채점 버튼을 본 세 개의 눈 (창고판)",
      subtitle: "차이는 창고를 '저장되는 곳'으로 보는가, 표·규칙·열쇠로 보는가",
      before: {
        label: "❌ 창고 = 점수가 저장되는 곳",
        prompt: "점수를 저장하고 리더보드를 보여줘",
        result: "세션 제목이 제출마다 40번 반복되고, 오타 하나에 세션이 둘로 갈라지고, 창고 열쇠가 브라우저에 있어 누구나 내 점수를 고칠 수 있다"
      },
      after: {
        label: "✅ 4단 + 줄 하나 + 문지기",
        prompt: "세션 표(코드 유일 · 모드 5종) + 제출 표(세션번호 → 세션.번호, 삭제 연쇄) / 두 표 모두 읽기 O · 쓰기 O · 고치기 X · 지우기 X / Claude 열쇠는 서버 서랍에만",
        result: "표마다 열·규칙·문지기를 적을 수 있다 — 그게 곧 데이터 설계"
      }
    },
    parts: [
      {
        title: "Part 1. 표와 열 — 창고는 표의 묶음이다",
        content: [
          {
            subtitle: "데이터가 사는 곳은 셋 — 주머니 · 손 · 창고",
            quote: "데이터는 화면 뒤에 쌓인 것이 아니라, 표와 규칙과 열쇠로 지켜지는 것이다.",
            text: "쓰다 만 프롬프트가 새로고침해도 남는 건 내 폰 주머니(브라우저 저장)에 넣어 둔 것. '1분에 10번' 제한은 서버가 손에 쥐고 세는 숫자 — 서버가 꺼지면 0. 점수·닉네임·리더보드는 창고(DB) — 앱을 꺼도, 서버가 재시작돼도, 모두에게. 가르는 질문 하나: '껐다 켜도 있어야 하나? 남이 봐야 하나?' 창고에 넣는 데는 값이 들기 때문에(표 설계·규칙·열쇠) 남아야 하는 것만 창고에.",
            tip: "이 수업은 대시보드도 SQL 편집기도 띄우지 않는다 — 딱 한 장(정체 공개), 표의 열 여덟 개를 표 만드는 문장 여덟 줄과 대조하는 장면만 예외. 읽기·쓰기 문장은 우리말 번역으로만."
          },
          {
            subtitle: "창고 해부 4단 — 리더보드 한 장을 뒤집어 네 번 다르게 본다",
            table: {
              title: "표 · 열 · 규칙 · 열쇠",
              rows: [
                { axis: "표 (테이블)", question: "창고는 표의 묶음 — 한 표 = 한 종류의 사실, 한 줄 = 사실 하나('민지가 이 세션에 92점을 3시 12분에 냈다'). 세션 표 7열 · 제출 표 8열. 리더보드는 표가 아니라 제출 표를 읽어 그린 것. 엑셀과 다른 점 셋 — 종류 고정 · 규칙 · 동시 사용" },
                { axis: "열 (컬럼)", question: "열마다 들어갈 것이 정해져 있다 — 글자·숫자·시각·참/거짓·덩어리. 총점을 글자 열에 넣으면 정렬할 때 '9' > '87'. 필수인 열(닉네임), 비워도 되는 열(호스트 이름), 안 적으면 채워지는 열(제출 시각 = 지금, 만료 = +24시간)" },
                { axis: "규칙 (제약 · 관계)", question: "표는 스스로를 지킨다 — 유일(세션 코드 중복이면 창고가 거절 → 앱은 3번 재시도) · 허용목록(모드 5종) · 필수. 앱은 여럿이 되고 창고는 하나니까 규칙은 창고에. 그리고 줄 잇기 — 제출.세션번호 → 세션.번호" },
                { axis: "열쇠 (보안)", question: "열쇠는 둘 — 비밀 열쇠(Claude, 쓰면 돈이 나간다 → 서버 서랍에만)와 공개 열쇠(창고, 브라우저에 실려 나간다). 공개 열쇠가 안전한 이유 = 문지기: 표마다 읽기·쓰기·고치기·지우기 네 칸. 채점기는 읽기 O · 쓰기 O · 고치기 X · 지우기 X" }
              ]
            }
          },
          {
            subtitle: "왜 표가 둘인가 — 같은 원리가 크기만 다르게 세 번",
            text: "세션에 40명이 제출했다고 하자. 세션 제목·호스트·모드를 제출 줄마다 적으면 40줄에 반복되고, 제목을 고치려면 40줄 수술, 한 줄 오타('1감')면 창고 입장에선 세션이 둘로 갈라진다. 그래서 세션 표와 제출 표로 가른다 — 제목은 한 번만, 제출은 세션의 번호만 들고 있다. 폴더를 갈랐고(12차), 부품을 갈랐고(14차), 오늘은 표를 가른다. 반복되면 가른다."
          }
        ]
      },
      {
        title: "Part 2. 관계 · 열쇠 · 문지기 — 표 두 장과 줄 하나",
        content: [
          {
            subtitle: "관계 — 줄 잇기 (오늘의 핵심 개념)",
            table: {
              title: "갈라진 두 표를 다시 잇는 법",
              rows: [
                { axis: "① 번호는 창고가 붙인다", question: "닉네임 '민지'는 둘일 수 있어도 번호는 절대 안 겹친다 — 사람이 정하지 않고 창고가 붙여야 가리킬 수 있다" },
                { axis: "② 줄은 번호 쪽으로", question: "제출 표의 「세션번호」에 세션 표의 번호가 들어간다 — 여러 제출 → 한 세션. 없는 번호를 넣으면 창고가 거절" },
                { axis: "③ 삭제 연쇄", question: "세션을 지우면 그 세션의 제출도 같이 사라지게 — 주인 없는 제출이 남지 않게" },
                { axis: "읽기 한 문장", question: "'제출 표에서, 이 세션 것만, 시간순으로, 전부 줘' — 그다음 닉네임별 최고점·제출 횟수·상승폭은 앱이 계산. 재제출하면 줄이 늘어난다(덮어쓰지 않는다) — 창고는 사실을 남기고, 판단은 읽을 때 한다" }
              ]
            },
            quote: "표 두 장과 줄 하나 — 데이터 설계의 90%. 이 줄을 그을 수 있으면 데이터도 절반은 끝이다."
          },
          {
            subtitle: "열쇠 두 개와 문지기 — 12차 떡밥을 갚는다",
            text: "12차 채점 버튼의 여정에서 '열쇠는 서버에서만 — 원리는 16차에서'라고 했다. 비밀 열쇠(Claude)는 쓰면 돈이 나가는 법인카드 — 브라우저에 두면 강의실 전원이 내 카드로 채점하니 서버 서랍(.env)에만. 공개 열쇠(창고)는 브라우저에 실려 나간다 — 리더보드를 그리려면 브라우저가 창고를 읽어야 하니까. 그런데도 내 92점을 100점으로 못 고치는 건 문지기 덕: 표마다 읽기·쓰기·고치기·지우기를 정하면 허락 안 한 일은 전부 거절된다. 문지기가 없으면 공개 열쇠는 창고 열쇠를 길에 떨어뜨린 것. 아파트 공동 현관 비밀번호는 다 알아도 각 집 문은 따로 잠겨 있다. 24시간 만료도 지우는 게 아니라 열 하나(만료 시각)를 앱이 읽을 때 판단할 뿐 — 지우지 않으니 나중에 셀 수 있다."
          },
          {
            subtitle: "좋은 데이터의 원칙 5 · 숙제: 내 앱 데이터도",
            table: {
              title: "좋은 데이터의 원칙 5 (= 데이터도 숙제 채점 기준)",
              rows: [
                { axis: "① 한 표 = 한 종류의 사실", question: "세션 표엔 세션만, 제출 표엔 제출만 — 섞이면 '이 줄은 뭐지?'" },
                { axis: "② 반복되면 표를 가르고 줄로 잇는다", question: "제목 40번 반복 → 세션 표로 빼고 번호로 가리킨다" },
                { axis: "③ 규칙은 앱이 아니라 창고에", question: "유일 · 허용목록 · 필수 — 앱은 여럿이 되고 창고는 하나" },
                { axis: "④ 비밀 열쇠는 서버에만, 공개 열쇠엔 문지기 ⭐", question: "Claude 키는 .env · 창고 키는 공개하되 고치기·지우기 X" },
                { axis: "⑤ 지우지 말고 남긴다", question: "재제출은 줄 추가, 최고점은 읽을 때 — 그래서 '오늘의 성장왕'이 가능했다" }
              ]
            },
            text: "증거 — 채점기는 리더보드 표를 따로 만들지 않았다. 제출 표에서 읽을 때 계산한다(표를 하나 더 만들면 두 표를 맞춰야 하니까 — 같은 사실 두 곳 = 원칙 ① 위반). 숙제 — 내 앱 데이터도(A4 4쪽, 작성 순서 5단계 + 완성 예시 「점심 메뉴 뽑기」 내장). 화면도가 없어도 시작할 수 있다. 합격 기준 셋: 표 2개 이상·표마다 열 3개 이상 / 표 사이 줄 1개 + '왜 갈랐나' / 문지기 표에서 고치기·지우기 칸을 비우지 않음(X도 답). 구조도·화면도·데이터도 세 장을 한 봉투에 — 다음 시즌 첫 프롬프트는 이 세 장에서 나온다."
          }
        ]
      }
    ],
    habits: [
      {
        title: "남는 것과 흐르는 것 가르기",
        description: "앱을 떠올리면 '껐다 켜도 있어야 하나? 남이 봐야 하나?'부터 묻는 습관 — 창고에 넣을 것만 표가 된다"
      },
      {
        title: "반복되는 글이 보이면 표를 가르기",
        description: "한 표의 줄마다 같은 글이 들어갈 것 같으면 표를 빼고 번호로 잇는 습관 — 폴더·부품·표, 같은 원리"
      },
      {
        title: "표마다 네 칸 채우기",
        description: "AI에게 앱을 시키기 전에 표마다 읽기·쓰기·고치기·지우기를 누가 하는지 적는 습관 — 안 적으면 AI는 '모두 다 할 수 있게' 만든다"
      }
    ],
    checkCard: [
      { code: "표", name: "표·열", question: "한 표에 한 종류만 있나? 열마다 이름·종류·필수?를 적었나?" },
      { code: "줄", name: "관계", question: "어느 표의 어느 열이 어느 표의 번호를 가리키나? 왜 갈랐나?" },
      { code: "문", name: "문지기", question: "표마다 읽기·쓰기·고치기·지우기 네 칸을 채웠나? (X도 답, 빈칸은 답이 아님)" },
      { code: "쇠", name: "비밀 열쇠", question: "외부 서비스 열쇠는 서버 서랍에 두기로 적었나?" }
    ],
    conclusion: "12차엔 지형으로, 14차엔 화면으로, 오늘은 창고로 — 같은 3초를 세 번 봤습니다. 채점 버튼 여섯 걸음 중 창고에 남는 순간은 등록 한 번뿐이고, 그 줄 하나가 표와 규칙과 열쇠로 지켜집니다.\n\n구조도의 데이터 폴더 → 화면도의 보이는 데이터 칸 → 데이터도의 표와 열. 세 장이 한 줄로 이어지면 「내 앱 설계 3종 세트」가 완성됩니다. 다음 시즌은 이 세 장을 들고 AI에게 시키는 시즌입니다.",
    challenge: "숙제는 내 앱 데이터도(4쪽) — 종이와 펜이면 충분하고, 화면도가 없어도 시작할 수 있습니다. 합격 기준 셋: 표 2개 이상·열 3개 이상 / 표 사이 줄 1개 + 왜 갈랐나 / 문지기 표 고치기·지우기 칸 채우기. 구조도·화면도·데이터도 세 장을 한 봉투에 넣어 두세요.",
    faqs: [
      {
        q: "SQL은 언제 배우나요?",
        a: "다음 시즌에요. 오늘 본 표 만드는 문장 한 장이 전부입니다 — 표·열·규칙·열쇠의 눈이 없으면 SQL은 소음이에요. AI에게 '이런 표를 만들어라'라고 우리말로 시키면 AI가 SQL을 씁니다. 여러분이 챙길 건 표·열·줄·문지기, 데이터도에 있는 그것."
      },
      {
        q: "엑셀로 하면 안 되나요?",
        a: "작은 앱은 됩니다(구글 시트를 창고로 쓰는 앱도 있어요). 다르게 되는 건 셋 — 열의 종류가 정해져 있고, 규칙이 있고, 여럿이 동시에 씁니다. 엑셀은 사람이 지키고 창고는 창고가 지킵니다."
      },
      {
        q: "화면도를 못 그렸는데 데이터도를 그릴 수 있나요?",
        a: "됩니다. 데이터도 1단계는 '내 앱 화면에 보이는 숫자·이름·글'을 떠올려 적는 것이라 화면도 없이 시작합니다. 앱이 아예 없으면 2쪽 완성 예시(점심 메뉴 뽑기) 소재로 시작하세요."
      },
      {
        q: "24시간 지나면 세션이 지워지나요?",
        a: "아니요, 남습니다. 앱이 읽을 때 '만료 시각이 지났네' 하고 판단할 뿐이에요 — 원칙 ⑤ '지우지 말고 남긴다'. 지우지 않으니 나중에 '그날 몇 명 왔었지'를 셀 수 있습니다."
      },
      {
        q: "우리 회사 데이터도 이렇게 생겼나요?",
        a: "네. 표·열·규칙·열쇠는 어디나 같고 크기만 다릅니다 — 표 2장이 200장이 될 뿐. 데이터도를 그릴 줄 알면 회사 데이터도 읽을 수 있습니다."
      }
    ]
  }
];
