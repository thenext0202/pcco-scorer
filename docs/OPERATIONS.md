...
AI 채점기(R-PCCO & I-MRKO Scorer) 강의 운영을 위한 체크리스트 및 장애 대응 가이드입니다.
...
1. `/host` 에서 실제 세션 생성:
   - 제목: "AI 프롬프트 실습 - 2026년 4월 22일" (또는 "AI 지침 실습 ...")
   - 강사 이름: (본인 이름)
   - **채점 모드 선택**: 프롬프트(R-PCCO) 또는 지침(I-MRKO)
     - 1차 강의: 프롬프트 모드
     - 2차 강의: 지침 모드
...
**지침 모드일 경우:**
> "AI에게 줄 지침을 작성하세요. ## 헤더를 사용하면 가산점이 있습니다.
> 예: ## 정체성, ## 임무, ## 규칙, ## 지식, ## 출력
> '채점하기' 버튼을 눌러 I-MRKO 5요소로 평가받으세요!"
...
>
> ## 임무
> ① 주간 보고서 초안 ② 회의록 요약 ③ 이메일 톤 교정. 이 3가지를 주로 돕는다.
>
> ## 규칙
> - 결론 1줄 + 근거 3줄 이내
> - 문장 끝 '요' 금지 (반말 유지)
